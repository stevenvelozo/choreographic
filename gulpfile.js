...
const _CONFIG = (
	{
		...
		EntrypointInputSourceFile: `${__dirname}/source/Choreographic-Browser-Shim.js`,
		...
		LibraryObjectName: `Choreographic`,
		...
		LibraryUniminifiedFileName: `choreographic.js`,

		// The name of the minified version of the packaged library, for production release:
		LibraryMinifiedFileName: `choreographic.min.js`
	});
